...
const scoreViewStyle = StyleSheet.create({
    ...
    scoreView: {
        ...
        width : (Dimensions.get('window').width /(100/50) )/4 - 5,
        height : (Dimensions.get('window').width /(100/50) )/4 - 5,
        borderRadius: (((Dimensions.get('window').width /(100/50) )/4) - 5)/2,
    },
    textView: {
        marginTop : 5,
