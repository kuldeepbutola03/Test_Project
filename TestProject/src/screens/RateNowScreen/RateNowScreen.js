...
import { normalize, authHeaders, APP_GLOBAL_COLOR, SHARE_LINK, refreshUserNotification } from '../../../Constant';
...
export default class RateNowScreen extends Component {
  shareOptions = null;
  static propTypes = {
  ...
  componentDidMount() {
    ...
    let screenName = "RateNowScreen"// this.props.isPolice ? 'MLA_Screen' : 'MP_Screen';
